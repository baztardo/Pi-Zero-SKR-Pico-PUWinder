...
void process_command(const char* cmd) {
    ...
    if (strcmp(cmd, "PING") == 0) {
        ...
        uart_puts(PI_UART_ID, "Debug_Encoder_v1.0\n");
    }
        ...
        // DEBUG: Simple encoder RPM calculation
        uint32_t current_time = time_us_32();
        ...
        printf("DEBUG: elapsed_us=%u, pos_delta=%d, elapsed_sec=%.3f\n", 
               elapsed_us, pos_delta, elapsed_sec);
        
        if (elapsed_sec > 0.1f && abs(pos_delta) > 0) {  // At least 100ms and some movement
