// Z-Index RPM Calculation Firmware
...
void process_command(const char* cmd) {
    ...
    if (strcmp(cmd, "PING") == 0) {
        ...
        uart_puts(PI_UART_ID, "Z_Index_RPM_v1.0\n");
    }
        ...
        // Z-INDEX RPM: Calculate RPM from Z-index pulses (1 pulse per revolution)
        uint32_t current_time = time_us_32();
        ...
        if (elapsed_sec > 0.5f && z_delta > 0) {  // At least 500ms and some Z-index pulses
            ...
            printf("Z-index RPM: %.1f (%.1f rev/sec, %u delta)\n", 
...
int main() {
    ...
    printf("Z-Index RPM Calculation v1.0\n");
    ...
    printf("Z-index: 1 pulse per revolution\n");
