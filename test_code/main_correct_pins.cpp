// Correct Pin Assignment Firmware
...
// Encoder pins (CORRECT assignments)
...
void process_command(const char* cmd) {
    ...
    if (strcmp(cmd, "PING") == 0) {
        ...
        uart_puts(PI_UART_ID, "Correct_Pins_v1.0\n");
    }
        ...
        gpio_put(BLDC_ENABLE_PIN, 1);  // Enable RioRand controller
        ...
        gpio_put(BLDC_ENABLE_PIN, 0);  // Disable RioRand controller
        printf("BLDC stopped\n");
...
int main() {
    ...
    printf("Correct Pin Assignment v1.0\n");
    ...
    gpio_put(BLDC_ENABLE_PIN, 0);  // Start with RioRand disabled
    ...
    printf("Commands: SET_BLDC_RPM, STOP_BLDC, GET_ENCODER, GET_HALL, GET_RPM, RESET_ALL\n");
